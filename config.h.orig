...
static const char *fonts[]          = { "Terminus (TTF):pixelsize=18" };
...
static const char *clipcmd[]  = { "xsetroot", "-name", "$(xclip -o)", NULL };
...
static const char *dmenuunicode[] = { "dmeuunicode", NULL };
static const char *network[] = { "nmtui", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_F12,	   spawn,	   {.v = network } },
	{ MODKEY,			XK_F4,	   spawn,	   {.v = dmenuunicode } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
